  ...
  .catch(error => console.error(error));
	...
	<div className="container flex flex-col items-center justify-center p-4 mx-auto space-y-8 sm:p-10">
		...
		<div className="flex flex-row flex-wrap-reverse justify-center">
			...
			<div className="flex flex-col justify-center m-8 text-center">
				<img alt="" className="self-center flex-shrink-0 w-24 h-24 mb-4 bg-center bg-cover rounded-full dark:bg-gray-500" src="https://avatars.githubusercontent.com/u/108384746?v=4" />
				<p className="text-xl font-semibold leading-tight">Dibbo Das</p>
				<p className="dark:text-gray-400">Full Stack Developer</p>
				<div className='flex justify-center gap-4 text-xl mt-2'>
				<a target="_blank" href="https://www.linkedin.com/in/dibbo-das/"> <BsLinkedin/> </a>	<a target="_blank" href="https://github.com/WebDevDibbo"><BsGithub/></a>  <a target="_blank" href="https://portfolio-fd96a.web.app/"><GiEarthAmerica/> </a>
				</div>
			</div>
			<div className="flex flex-col justify-center m-8 text-center">
				...
				<p className="dark:text-gray-400">Full Stack Developer</p>
				<div className='flex justify-center gap-4 text-xl mt-2'>
				<a target="_blank" href="https://www.linkedin.com/in/md-abdur-rouf-likhon-70a562257/"> <BsLinkedin/> </a>	<a target="_blank" href="https://github.com/likhon29"><BsGithub/></a>  <a target="_blank" href="https://my-portfolio-b28f8.web.app/"><GiEarthAmerica/> </a>
				</div>
			</div>
			<div className="flex flex-col justify-center m-8 text-center">
				...
				<p className="dark:text-gray-400">Full Stack Developer</p>
				<div className='flex justify-center gap-4 text-xl mt-2'>
				<a target="_blank" href="https://www.linkedin.com/in/md-emon343/"> <BsLinkedin/> </a>	<a target="_blank" href="https://github.com/emon097"><BsGithub/></a>  <a target="_blank" href="https://md-emon-hossain-portfolio.netlify.app/"><GiEarthAmerica/> </a>
				</div>
			</div>
			<div className="flex flex-col justify-center m-8 text-center">
				...
				<p className="dark:text-gray-400">Full Stack Developer</p>
				<div className='flex justify-center gap-4 text-xl mt-2'>
				<a target="_blank" href="https://www.linkedin.com/in/md-mohaiminul-islam-299442131/"> <BsLinkedin/> </a>	<a target="_blank" href="https://github.com/JsArafath"><BsGithub/></a>  <a target="_blank" href="https://mohaiminul-islam-portfolio.netlify.app/"><GiEarthAmerica/> </a>
				</div>
			</div>
		</div>
	</div>
