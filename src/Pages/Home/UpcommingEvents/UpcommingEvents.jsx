...
const UpcommingEvents = () => {
    ...
    return (
        <div className='pb-9 pt-9' ><br />
            ...
            <h1 className='text-4xl font-semibold text-gray-600 text-center P-5'>We Arrange Many Social Events <br /> For Charity Donations</h1>

            <div className='eventcard pt-9' >
                    <div className="grid md:grid-cols-2 gap-10 px-10 md:px-24">
                        <div>
                        <div className="blogs">
                        {/* event--->1 */}
                            <div className="flex mb-12 drop-shadow-lg text-gray-700">
                                <div>
                        ...
                        {/* event--->2 */}
                            <div className="flex mb-12 drop-shadow-lg text-gray-700">
                                ...
                                <div className="pl-4 pt-4 bg-gray-50 rounded">
                        ...
                        {/* event--->4 */}
                            <div className="flex mb-12 drop-shadow-lg text-gray-800">
                                <div>
