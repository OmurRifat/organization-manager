      ...
      <div class="relative w-full max-w-md max-h-full">
        <div class="relative bg-[#80bfb8] rounded-lg shadow dark:bg-gray-700">
          <button
            ...
            type="button"
            class="absolute top-3  right-2.5 text-[red] bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white"
              ...
              <table class="w-full text-sm text-left  dark:text-gray-400">
                <tbody>
                  <tr class="border-b border-gray-200 dark:border-gray-700">
                    ...
                    <td class="px-8 py-4 "> {profile?.name}</td>
                  </tr>
                  <tr class="border-b border-gray-200 dark:border-gray-700">
                    <th
                      scope="row"
                    ...
                    <td class="px-8 py-4 ">{profile?.email}</td>
                  </tr>
                  ...
                  <tr class="border-b border-gray-200 dark:border-gray-700">
                    ...
                    <td class="px-8 py-4 ">{profile?.organization}</td>
                  </tr>
                </tbody>
              </table>
